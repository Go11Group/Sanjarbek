...
func (h *Handler) GetLessons(u *gin.Context) {
...
func (h *Handler) CreateLesson(u *gin.Context) {
	url := "http://localhost:8080" + u.Request.URL.String()
...
func (h *Handler) UpdateLesson(u *gin.Context) {
...
func (h *Handler) DeleteLesson(u *gin.Context) {
