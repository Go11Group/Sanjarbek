...
func (h *Handler) GetEnrollment(u *gin.Context) {
...
func (h *Handler) CreateEnrollment(u *gin.Context) {
	url := "http://localhost:8080" + u.Request.URL.String()
...
func (h *Handler) UpdateEnrollment(u *gin.Context) {
...
func (h *Handler) DeleteEnrollment(u *gin.Context) {
